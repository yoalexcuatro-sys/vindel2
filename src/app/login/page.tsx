  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="w-full max-w-4xl bg-white rounded-2xl shadow-xl overflow-hidden flex">
        ...
        {/* Left - Branding */}
        <div className="hidden md:flex md:w-2/5 bg-gradient-to-br from-[#13C1AC] to-[#0a9688] p-8 flex-col justify-between">
          ...
          <div>
            ...
            <p className="text-white/80 text-sm">Conectează-te pentru a gestiona anunțurile tale.</p>
          </div>
        ...
        <div className="flex-1 p-8">
          ...
          <p className="text-sm text-gray-500 mb-6">
            Nu ai cont? <Link href="/register" className="text-[#13C1AC] font-medium hover:underline">Înregistrează-te</Link>
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className="w-full pl-10 pr-10 py-2.5 text-sm bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-[#13C1AC]/20 focus:border-[#13C1AC] outline-none"
                    placeholder="••••••••"
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center gap-2 cursor-pointer">
                <input type="checkbox" className="w-3.5 h-3.5 text-[#13C1AC] rounded" />
                <span className="text-gray-600">Ține-mă minte</span>
              </label>
              <Link href="#" className="text-[#13C1AC] hover:underline">Ai uitat parola?</Link>
            </div>

            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-2.5 bg-[#13C1AC] hover:bg-[#0da896] text-white font-medium rounded-lg transition-all disabled:opacity-50"
            >
          ...
          <div className="grid grid-cols-2 gap-3">
            <button className="flex items-center justify-center gap-2 py-2 px-3 bg-white border border-gray-200 rounded-lg hover:bg-gray-50 text-sm">
