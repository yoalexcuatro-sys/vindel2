...
export default function LoginPage() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      setError('Nu s-a putut autentifica cu Google.');
    } finally {
      setIsLoading(false);
    }
  };
        ...
        <div className="flex-1 p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-2.5 bg-[#13C1AC] hover:bg-[#0da896] text-white font-medium rounded-lg transition-all disabled:opacity-50 flex items-center justify-center gap-2"
            >
              {isLoading ? (
                <>
