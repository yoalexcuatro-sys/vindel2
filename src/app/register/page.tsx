...
import { User, Building2, Mail, Lock, Eye, EyeOff, MapPin, Briefcase, Phone } from 'lucide-react';
        ...
        <div className="flex-1 p-6 lg:p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <div className="flex items-center justify-between pt-2">
              ...
              <button type="submit" disabled={isLoading} className="px-6 py-2.5 bg-[#13C1AC] hover:bg-[#0da896] text-white font-medium rounded-lg transition-all disabled:opacity-50">
